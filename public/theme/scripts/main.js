...
testTradingView.actionsFollowers = function () {
		$(".top-line--icon").click(function () {
				if ($(this).attr('data-status') === 'follow') {
						...
						var countFollowers = parseFloat($(this).parents('.table-line__item').parents('.table-master__line').find('.table-line__item--wrapper-row').find('.table-line__item--five').text());
						var newQuantityFollowers = countFollowers + 1;
						...
						var _countFollowers = parseFloat($(this).parents('.table-line__item').parents('.table-master__line').find('.table-line__item--wrapper-row').find('.table-line__item--five').text());
						var _newQuantityFollowers = _countFollowers - 1;
						$(this).parents('.table-line__item').parents('.table-master__line').find('.table-line__item--wrapper-row').find('.table-line__item--five').text(_newQuantityFollowers);
				}
		});
